"""Tests for Porsche Connect api."""
import asyncio

import aiohttp
from custom_components.porscheconnect.api import (
    PorscheConnectApiClient,
)
...
async def test_api(hass, aioclient_mock, caplog):
    ...
    api = PorscheConnectApiClient("test", "test", async_get_clientsession(hass))
